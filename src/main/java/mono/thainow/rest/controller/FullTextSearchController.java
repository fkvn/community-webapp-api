...
//	public List<Company> SearchCompanyByName(@RequestParam String keywords, @RequestParam boolean
//	fetchAll,
...
//			@RequestParam(defaultValue = "Date") String sort, @RequestParam(defaultValue = "desc")
//			String sortOrder,
...
//
//		SearchResponse<?> res = searchService.searchCompany(industry, keywords, location.getLat(),
//		location.getLng(),
...
//			@RequestParam(defaultValue = "-1") Long requesterId, @RequestParam(defaultValue = "")
//			String keywords,
//			@RequestParam(defaultValue = "All") String status, @RequestParam(defaultValue = "All")
//			String positions,
...
//			@RequestParam(defaultValue = "All") String status, @RequestParam(defaultValue = "All")
//			String type,
//			@RequestParam(defaultValue = "All") String costType, @RequestParam(defaultValue = "0")
//			Double minCost,
...
//			@RequestParam(defaultValue = "All") String status, @RequestParam(defaultValue = "All")
//			String condition,
//			@RequestParam(defaultValue = "All") String category, @RequestParam(defaultValue = "0")
//			Double minCost,
