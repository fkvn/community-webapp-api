...
//				.antMatchers(HttpMethod.GET, "/**").hasAuthority("post-service").antMatchers(HttpMethod.POST, "/**")
//				.hasAuthority("post-service").antMatchers(HttpMethod.PUT, "/**").hasAuthority("post-service")
//				.antMatchers(HttpMethod.PATCH, "/**").hasAuthority("post-service").antMatchers(HttpMethod.DELETE, "/**")
//				.hasAuthority("post-service").anyRequest().authenticated().and().oauth2ResourceServer().jwt()
