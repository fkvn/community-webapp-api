...
//                //				in default, we only return company with status as Registered
//                and
//                //				Unregistered
...
//                    //			keywords
//                    if (!keywords.isEmpty()) {
//                        b.must(f.match().field("name").boost(3.0f).field("industry").boost(2.0f)
//                                .field("description").boost(1.0f).matching(keywords));
//                    }
//
//                    //			status
//                    b.must(f.terms().field("status")
//                            .matchingAny(CompanyStatus.REGISTERED, CompanyStatus.UNREGISTERED));
//
//                    //			industry filter
...
//                            break;
//                        case "box": {
//                            GeoBoundingBox box = GeoBoundingBox.of(topLeft.get(0), topLeft.get(1),
...
//
//    @Override
//    public SearchResult<Deal> searchDeal(String keywords, int limit, int page, double centerLat,
...
//            //			keywords
//            if (!keywords.isEmpty()) {
//                b.must(f.match().field("title").boost(3.0f).field("category_search").boost(2.0f)
//                        .field("description").boost(1.0f).matching(keywords));
//            }
//
//            //			status
...
//                case "box": {
//                    GeoBoundingBox box =
//                            GeoBoundingBox.of(topLeft.get(0), topLeft.get(1), bottomRight.get(0),
//                                    bottomRight.get(1));
//
//                    b.must(f.spatial().within().field("location").boundingBox(box));
//                }
...
//                                               String amenity, String category, double centerLat,
...
//                                .boost(4.0f).field("type_search").boost(3.0f).field("description")
...
//
//    @Override
//    public SearchResult<DealPost> searchDealPost(Long requesterId, Long ownerId, String keywords,
...
//                        .boost(2.0f).field("deal.description").boost(1.0f).matching(keywords));
//            }
//
...
//                                                       Double maxCost, Integer guest, Integer bed,
...
//                        //				b.filter(f.match().field("housing.amenities").matching
//                        //				(amenity));
//                    }
//
//                    //			category filter
...
//
//    @Override
//    public SearchResult<JobPost> searchJobPost(Long requesterId, Long ownerId, String keywords,
//                                               String positions, String experience, String skills,
...
//
//    @Override
//    public SearchResult<PostReview> searchPostReview(Long postId, String sort, String sortOrder,
//                                                     int limit, int page,
