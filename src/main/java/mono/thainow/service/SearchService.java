...
public interface SearchService {
	...
	SearchResponse<?> searchDealPost(Long requesterId, Long ownerId, String category, String keywords, double centerLat,
			double centerLng, int limit, int page, String sort, String sortOrder, String within, int radius, List<Double> topLeft, List<Double> bottomRight, String status);

	SearchResponse<?> searchJobPost(Long requesterId, Long ownerId, String keywords, String position, String experience,
	...
	SearchResponse<?> searchHousingPost(Long requesterId, Long ownerId, String keywords, String type, String costType,
			Double minCost, Double maxCost, Integer guest, Integer bed, Integer parking, Integer bath,
			String amenity, String category, double centerLat, double centerLng, int limit, int page, String sort,
			String sortOrder, String within, int radius, List<Double> topLeft, List<Double> bottomRight, String status);

	SearchResponse<?> searchMarketplacePost(Long requesterId, Long ownerId, String keywords, String condition,
