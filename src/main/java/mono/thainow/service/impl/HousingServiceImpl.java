...
////			housing.setLocation(locationService.findLocationByPlaceidOrAddress(placeid,
// address));
////		}
////
//////		new cover pictures
...
////
//////		interior information
////		TreeMap<String, Integer> interior = Optional.ofNullable(request.getInterior()).orElse
// (null);
////		housing.setInterior(interior != null ? interior : new TreeMap<>(String
// .CASE_INSENSITIVE_ORDER));
////
//////		amenities
////		TreeSet<String> amenities = Optional.ofNullable(request.getAmenities()).orElse(null);
////		housing.setAmenities(amenities != null ? amenities : new TreeSet<>(String
// .CASE_INSENSITIVE_ORDER));
////
//////		type
