...
//			status) {
//
//		SearchResult<DealPost> result = searchDao.searchDealPost(requesterId, ownerId, keywords,
...
//
//	@Override
//	public SearchResponse<?> searchJobPost(Long requesterId, Long ownerId, String keywords, String
//	positions,
//			String experience, String skills, Boolean remote, double centerLat, double centerLng,
//			int limit, int page,
...
//			String category, Double minCost, Double maxCost, double centerLat, double centerLng,
//			int limit, int page,
//			String sort, String sortOrder, String within, int radius, List<Double> topLeft,
//			List<Double> bottomRight, String status) {
//
...
//
//		SearchResult<PostReview> result = searchDao.searchPostReview(id, sort, sortOrder, limit,
...
//
//	@Override
//	public SearchReviewResponse<?> serachProfileReview(Long id, String sort, String sortOrder, int
//	limit, int page) {
//
//		AggregationKey<Map<Integer, Long>> countsByRateKey = AggregationKey.of("countsByRate");
//
