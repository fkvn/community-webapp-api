...
//
//    @Override
//    public Marketplace fetchMarketplaceFromRequest(Marketplace marketplace, MarketplaceRequest
//    request) {
//
//        if (marketplace == null) {
...
//
////		status
//        PostStatus status = Optional.ofNullable(request.getStatus()).orElse(marketplace
//        .getStatus());
...
//
////	@Override
////	public Marketplace fetchMarketplaceFromUpdateRequest(Marketplace marketplace,
...
////			marketplace.setLocation(locationService.findLocationByPlaceidOrAddress(placeid,
// address));
////		}
////
//////		new cover pictures
