...
//		return company.getLogoUrl();
	...
	@Override
	public Company getCompanyFromUpdateRequest(Company company,
			@Valid CompanyRequest request) {
...
//		new cover pictures
		List<StorageRequest> coverPictureRequests = Optional.ofNullable(request.getCoverPictures())
				.orElse(null);
