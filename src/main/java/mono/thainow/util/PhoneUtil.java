...
public class PhoneUtil {
    ...
    public static void validatePhoneNumberWithGoogleAPI (String[] phoneNumbers,
                                                         String region) {
...
//		validate region
    ...
    public static String getPhoneNumberWithRegionCode (String phone,
                                                       String region) {
...
//		phone format 10-digits: xxxxxxxxxx
    ...
    public static void validatePhoneNumberWithGoogleAPI (String phone,
                                                         String region) {
